              ...
              <View key={index}>
                ...
                <View
                  ...
                  <Text style={HomeBodyStyle.like}>
                    Liked by{' '}
                    <Text style={{fontWeight: 'bold'}}>craig_love</Text> and{' '}
                    <Text style={{fontWeight: 'bold'}}>{item.total_like}6 others</Text>
                  </Text>
                </View>
                <View
                  style={{
                  ...
                  <Text style={HomeBodyStyle.comment}>
                    <Text style={{fontWeight: 'bold'}}>joshua_l</Text> The game

        ...
        <View>
            ...
            <View
              ...
              <TouchableOpacity>
                <Image
                  ...
                  source={require('../../assets/Icons/heart.jpg')}
                />
              </TouchableOpacity>
              <TouchableOpacity>
                <Image
          ...
          <View
            ...
            <Text style={FeedPostBodyStyle.like}>
              Liked by <Text style={{fontWeight: 'bold'}}>craig_love</Text> and <Text style={{fontWeight: 'bold'}}>44,686 others</Text>
            </Text>
          </View>
          <View
            style={{
            ...
            <Text style={{fontWeight: 'bold'}}>joshua_l</Text> The game in Japan was amazing and I want to share some
              photos
            </Text>
          </View>
        </View>

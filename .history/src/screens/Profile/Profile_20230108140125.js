    ...
    return (
      <View style={FeedPostHeaderStyle.container}>
        ...
        <View style={FeedPostHeaderStyle.userStatistics}>
          <Text style={FeedPostHeaderStyle.userStatistics}>54</Text>
          <Text>Posts</Text>
        </View>
        <View style={FeedPostHeaderStyle.userStatistics}>
          <Text style={FeedPostHeaderStyle.userStatistics}>834</Text>
          <Text>Followers</Text>
        </View>
        <View style={FeedPostHeaderStyle.userStatistics}>
          <Text style={FeedPostHeaderStyle.userStatistics}>162</Text>
          <Text>Following</Text>
        </View>
      </View>
    );

...
const Profile = ({navigation}) => {
    ...
    return (
      <View style={FeedPostHeaderStyle.container}>
        ...
        <View style={FeedPostHeaderStyle.userBtn}>
          <TouchableOpacity style={FeedPostHeaderStyle.button} onPress={() => navigation.push('Detail Profile')}>
        ...
        <View style={FeedPostHeaderStyle.userStory}>
          <View style={FeedPostHeaderStyle.story}>
            ...
            <Text style={ProfilePostStyle.text}>New</Text>
          </View>
          <View style={FeedPostHeaderStyle.story}>
            <TouchableOpacity>
              <Image
            ...
            <Text style={ProfilePostStyle.text}>Friends</Text>
          </View>
          <View style={FeedPostHeaderStyle.story}>
            <TouchableOpacity>
              <Image
            ...
            <Text style={ProfilePostStyle.text}>Sport</Text>
          </View>
          <View style={FeedPostHeaderStyle.story}>
            <TouchableOpacity>
              <Image
            ...
            <Text style={ProfilePostStyle.text}>Design</Text>
          </View>
        </View>
      </View>
    );
  ...
  return (
    <ScrollView>
      <View style={ProfilePostStyle.container}>
        <FeedPostHeader />
        <FeedPostBody />
      </View>
    </ScrollView>
...
const ProfilePostStyle = StyleSheet.create({
  container: {
    // marginBottom: 20,
    paddingBottom: 20,

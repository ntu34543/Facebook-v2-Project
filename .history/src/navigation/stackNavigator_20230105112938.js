...
const SearchStackNavigator = () => {
  return (
    <Stack.Navigator screenOptions={Search}>
      <Stack.Screen name="Search" component={MyPosts} />
    </Stack.Navigator>
  );
};

export {HomeStackNavigator, ProfileStackNavigator, PostStackNavigator, SearchStackNavigator};

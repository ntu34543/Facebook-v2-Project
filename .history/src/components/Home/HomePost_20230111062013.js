        ...
        <View>
          <View>
            ...
            <View
              ...
              <Text style={HomeBodyStyle.like}>
                Liked by <Text style={{fontWeight: 'bold'}}>User {item.id_user}</Text>{' '}
                and <Text style={{fontWeight: 'bold'}}>{item.total_like} others</Text>
              </Text>
            </View>
            <View
              style={{
              ...
              <Text style={HomeBodyStyle.comment}>
                <Text style={{fontWeight: 'bold'}}>User {item.id_user}</Text> {item.content}
              </Text>
            </View>
          </View>
        </View>
